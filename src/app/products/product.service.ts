...
export class ProductService {
    ...
    getProducts(): Observable<IProduct[]> {
         return this.http.get<IProduct[]>(this.baseUrl)
            ...
            .do(data => console.log('getProducts: ' + JSON.stringify(data), ( this.handleError)))
            ;
    }
    ...
    private createProduct(product: IProduct, options: RequestOptions): Observable<IProduct> {
        ...
        return this.http.post<IProduct>(this.baseUrl, product, options.body)
            // .map(this.extractData)
    ...
    private updateProduct(product: IProduct, options: RequestOptions): Observable<IProduct> {
        ...
        return this.http.put<IProduct>(url, product, options.body)
            // .map(() => product)
